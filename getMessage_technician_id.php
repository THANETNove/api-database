...
if (isset($_GET)) {
	...
	if ($_GET['isAdd'] == 'true') {
		...
		FROM message  LEFT JOIN image_profile ON message.id_technician = image_profile.id_user WHERE message.idUser='$id_user'  AND message.id_technician='$id_tech'   LIMIT 50");
		if ($result) {
